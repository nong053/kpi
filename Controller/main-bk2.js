...
var fnDropdownListDep=function(department_id,paramSelectAll){
	...
	$.ajax({
		...
		success:function(data){
			...
			htmlDropDrowList+="<select id=\"department_id\" name=\"department_id\" class=\"form-control \" >";
...
var fnDropdownListPosition=function(position_id,paramSelectAll){
	...
	$.ajax({
		...
		success:function(data){
			...
			var htmlDropDrowList="";
			htmlDropDrowList+="<select id=\"position_id\" name=\"position_id\" class=\"form-control \" >";
			//htmlDropDrowList+="<option value=\"All\" >ทั้งหมด</option>";
				$.each(data,function(index,indexEntry){
...
var fnDropdownListDiv=function(division_id){
	...
	$.ajax({
		...
		success:function(data){
			//alert(data);
			var htmlDropDrowList="";
			htmlDropDrowList+="<select id=\"division_id\" name=\"division_id\" class=\"form-control \" >";
			//htmlDropDrowList+="<option value=\"All\" >ทั้งหมด</option>";
				$.each(data,function(index,indexEntry){
...
var fnDropdownListRole=function(role_id){
	...
	$.ajax({
		...
		success:function(data){
			...
			var htmlDropDrowList="";
			htmlDropDrowList+="<select id=\"role_id\" name=\"role_id\" class=\"form-control \" >";
...
var fnDropdownListKPI=function(kpi_id){
	...
	$.ajax({
		...
		success:function(data){
			...
			var htmlDropDrowList="";
			htmlDropDrowList+="<select id=\"kpi_id\" name=\"kpi_id\" class=\"form-control \" >";
				$.each(data,function(index,indexEntry){
...
var fnDropdownListEmployee=function(position_id,emp_id){
	...
	$.ajax({
		...
		success:function(data){
			...
			var htmlDropDrowList="";
			htmlDropDrowList+="<select id=\"employee_id\" name=\"employee_id\" class=\"form-control \" >";
			//htmlDropDrowList+="<option value=\"All\" >ทั้งหมด</option>";
				$.each(data,function(index,indexEntry){
...
*/
	...
	var paramYear=function(kpi_year){
			...
			$.ajax({
				...
				success:function(data){
					var htmlDropDrowList="";
					htmlDropDrowList+="<select id=\"appraisal_year\" name=\"appraisal_year\" class=\"form-control \" >";
						$.each(data,function(index,indexEntry){
