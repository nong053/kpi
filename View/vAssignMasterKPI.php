...
if($_SESSION['language']=="th"){
	...
	$_SESSION['assign_l_des_btn_confirm']="ยืนยัน";

	//Search
	$_SESSION['assign_l_search_year']="ปีประเมิน";
	$_SESSION['assign_l_search_appraisalPeriod']="ช่วงการประเมิน";
	$_SESSION['assign_l_search_department']="แผนก";
	$_SESSION['assign_l_search_position']="ระดับ";
	...
	$_SESSION['assign_l_des_btn_confirm']="Confirm";
	   		...
	   		<!-- content start-->
				<form id="AssignKpiForm">
					<row>
						...
						<tr>
							<td style="width: 150px;" class='text-right'><b><?=$_SESSION['assign_l_search_department']?></b></td>
							<td id="assignDepartmentInformArea" >
								
							</td>
						</tr>
						<tr>
							<td style="width: 150px;" class='text-right'><b><?=$_SESSION['assign_l_search_position']?></b></td>
...
<table>
	<tr>
		...
		<td><b><?=$_SESSION['assign_l_search_appraisalPeriod']?></b></td>
		<td id="periodAssignArea">
			
		</td>
	
		<td>
			<b><?=$_SESSION['assign_l_search_department']?></b>
		</td>
		<td>
		...
		<td>
	 	...
	 	-->
		<td><b><?=$_SESSION['assign_l_search_position']?></b></td>
