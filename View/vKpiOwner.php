...
if($_SESSION['language']=="th"){
		...
		//Search
	$_SESSION['kpi_owner_search_year']="ปีการประเมิน";
	...
	//page owner
	$_SESSION['kpi_owner_l_by_owner']="ผลการประเมินองค์กร";
	$_SESSION['kpi_owner_l_by_appraisal']="ผลการประเมินตามช่วงการประเมิน";
	$_SESSION['kpi_owner_l_by_department']="ผลการประเมินแต่ละแผนก/ฝ่าย";
	$_SESSION['kpi_owner_l_by_kpi']="ผลการประเมินรายตัวชี้วัด";

	//table
	$_SESSION['kpi_owner_l_tbl_title1']="ตัวชี้วัด";
	$_SESSION['kpi_owner_l_tbl_title2']="ผลการประเมินรายตัวชี้วัด";

	$_SESSION['kpi_owner_l_tbl_id']="#";
	$_SESSION['kpi_owner_l_tbl_kpi_name']="ตัวชี้วัด";
	$_SESSION['kpi_owner_l_tbl_target']="เป้า";
	$_SESSION['kpi_owner_l_tbl_actual']="ผลการประเมิน";
									...
									<div class="topParameter">
										...
										<!-- Parameter Top KPI Owner Page Start-->
											<row class="topParameter">
												<div class="box1" style='text-align:right;' ><div >
