...
if($_SESSION['language']=="th"){
	...
	$_SESSION['emp_evaluate_l_tbl_target']="เป้าหมาย";
	$_SESSION['emp_evaluate_l_tbl_target_score']="ผลปฏิบัติงาน";
	$_SESSION['emp_evaluate_l_tbl_manage']="จัดการ";
									...
									<div class="row1 container1 ">
										...
										<div class="col-md-3">
											<div class="row1 alert alert-success">
												<div class="col-md-12 ">
													<div><b> <?=$_SESSION['emp_evaluate_l_form_acutal_data']?></b></div>
