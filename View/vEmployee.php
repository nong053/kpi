...
if($_SESSION['language']=="th"){
	...
	$_SESSION['employee_l_search_position']="ระดับ";
	...
	$_SESSION['employee_l_tbl_position']="ระดับ";
	...
	//form
	$_SESSION['employee_l_form_name']="ฟอร์มพนักงาน";
	...
	$_SESSION['employee_l_form_position']="ระดับ";
	$_SESSION['employee_l_form_position2']="ตำแหน่ง";
	
	$_SESSION['employee_l_form_status']="สถานะการทำงาน";
	...
	$_SESSION['employee_l_form_status_marital']="สถานะ";
	...
	$_SESSION['employee_l_form_position']="Level";
	$_SESSION['employee_l_form_position2']="Position";
  ...
  <div class="modal-dialog modal-lg" role="document">
   ...
   <div class="modal-content"> 
				...
				<row>
					...
					<div class="col-md-6">
						...
						<table class="employeeData" style="display:none;" >
							...
							<tr>
								<td class='text-right'><b><?=$_SESSION['employee_l_form_position2']?><!-- <font color="red">*</font> --></b></td>
								<td><input type="text" name="empPosition2" id="empPosition2" class="form-control input-sm"> </td>
							</tr>
							...
							<tr>
								<td class='text-right'><b><?=$_SESSION['employee_l_form_tel']?><!-- <font color="red">*</font> --></b></td>
								<td><input type="text" name="empTel" id="empTel" class="form-control input-sm"></td>
							</tr>
							<tr>
								<td class='text-right'><b><?=$_SESSION['employee_l_form_email']?><!-- <font color="red">*</font> --></b></td>
	   ...
	   <div class="modal-footer"> 
	   		...
	   		<input type="hidden" name="empAction" id ="empAction" class="empAction" value="add">
			<input type="hidden" name="empId" id ="empId"  class="empId" value="">
			<input type="submit" id="empSubmit" name="empSubmit" class="btn btn-primary btn-sm"  value="<?=$_SESSION['employee_l_form_btn_add']?>">
			<input type="reset" value="<?=$_SESSION['employee_l_form_btn_reset']?>" id="empReset" class="btn default  btn-sm" >
	...
	<tr>
		...
		<td id="depSearchDropDrowListArea">
			...
			<td id="divSearchDropDrowListArea">
			 ...
			 -->
		<td><b><?=$_SESSION['employee_l_search_position']?></b></td>
		...
		<td><b><?=$_SESSION['employee_l_search_status']?></b></td>
...
<div style="margin-top: 5px;" class="panel panel-default panel-bottom">
		  <div class="panel-heading">
				...
				<button data-toggle="modal" data-target="" class="btn btn-primary btn-xs" id="btnAddEmployee" type="button"><i class="glyphicon  glyphicon-plus"></i>
