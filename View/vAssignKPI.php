...
if($_SESSION['language']=="th"){
	...
	$_SESSION['kpi_result_l_search_appraisalPeriod']="ช่วงการประเมิน";
	$_SESSION['kpi_result_l_search_department']="แผนก";
	$_SESSION['kpi_result_l_search_position']="ระดับ";
...
<table>
	<tr>
		...
		<td><b><?=$_SESSION['kpi_result_l_search_appraisalPeriod']?></b></td>
		<td id="periodAssignArea">
			
		</td>
	
		<td>
			<b><?=$_SESSION['kpi_result_l_search_department']?></b>
		</td>
		<td>
		...
		<td>
	 	...
	 	-->
		<td><b><?=$_SESSION['kpi_result_l_search_position']?></b></td>
