							...
							<div class="panel panel-default panel-bottom" style="margin-top: 5px;">
		  						...
		  						<!--  table grid start -->
					    			<table id="gridPersonalKPI-<?=$emp_id?>">
						                ...
						                <thead>
						                    <tr>
						                        <th data-field="Field1" ><b><?=$_SESSION['emp_dashboard2_l_tbl_id']?></b></th>
						                        <th data-field="Field2"><b><?=$_SESSION['emp_dashboard2_l_tbl_kpi_name']?></b></th>
						                        <th data-field="Field3"><b><?=$_SESSION['emp_dashboard2_l_tbl_target']?></b></th>
						                        <th data-field="Field4"><b><?=$_SESSION['emp_dashboard2_l_tbl_actual']?></b></th>
						                        <th data-field="Field5"><b><?=$_SESSION['emp_dashboard2_l_tbl_graph']?></b></th>
						                        <th data-field="Field6"><b><?=$_SESSION['emp_dashboard2_l_tbl_actual_target']?></b></th>
						                        <th data-field="Field7"><b><?=$_SESSION['emp_dashboard2_l_tbl_status']?></b></th>
						                    </tr>
						                </thead>
						                <tbody>
						                    <tr>
