...
$_SESSION['main_menul_l_appraisalPeriod']="งวดการประเมิน";
    ...
    <div class="navbar navbar-blue navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header" >
          ...
          <a style='height: 0px;' class="navbar-brand" href="#" > <span class="iconMenu glyphicon glyphicon-dashboard"></span> Key Performance Indicators</a>
        </div>
			...
			<span class="caret"></span>
				...
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
					...
					if($_SESSION['admin_status']==1 or $_SESSION['admin_status']==3){
						?>
							<a href='../admin' id='profile' class=''><i class="icon-off"></i>Control Panel</a>
						<?
					}
					?>
						<a href='?language=EN' id='EnLanguage' class=''><i class="icon-off"></i>EN</a>
						<a href='?language=TH' id='thLanguage' class=''><i class="icon-off"></i>ไทย</a>
						<a href='#' id='logout' class=''><i class="icon-off"></i>Logout</a>
