...
if($_POST['action']=="add"){
	...
	$strSQL="INSERT INTO kpi(kpi_name,kpi_detail,admin_id,kpi_code,department_id)
	VALUES('$kpiName','$kpiDetail','$admin_id','$kpiCode','$departmentId')";
...
if($_POST['action']=="showData"){
	...
	where kpi.admin_id='$admin_id' and department_code='$departmentId' 
			order by kpi_id ";
