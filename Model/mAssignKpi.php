	...
	*/
	while($rs=$result->fetch_assoc()){
		...
		if(empty($rs['emp_picture_thum'])){
			$tableHTML.="<div style='text-align:center;'>	<img id='image_emp_data-".$rs['emp_id']."' style='opacity:0.1;' class=\"img-circle shadow\" src=\"../View/uploads/avatar.jpg\" width=\"100\" height='100'><a id='actionViewEmployee-".$rs['emp_id']."' class='actionViewEmployee'>".$rs['emp_code']."</a></div>";
		}else{
			$tableHTML.="<div style='text-align:center;'>	<img id='image_emp_data-".$rs['emp_id']."' class=\"img-circle\" src=\"".$rs['emp_picture_thum']."\" width=\"100\"  height='100'><a id='actionViewEmployee-".$rs['emp_id']."' class='actionViewEmployee'>".$rs['emp_code']."</a></div>";
		}
		$tableHTML.="</div>";
		$tableHTML.="<div>
